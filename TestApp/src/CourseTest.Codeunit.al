codeunit 50152 "Course Test"
{
    ...
    var
        ...
        DocumentNo: Code[20];
    begin
        // [Scenario] Al registrar un documento de venta para un curso y edicion, la edicion se guarda correctamente en los documentos registrados.

        //[Given] Necesitamos un curso con edición. Un documento de venta para el curso y edición.
        LibraryCourse.CreateCourse(Course);
        ...
        LibraryAssert.AreEqual(CourseEdition.Edition, SalesShipmentLine."Course Edition", 'La edicion en el albarán no es correcta');
    end;
}